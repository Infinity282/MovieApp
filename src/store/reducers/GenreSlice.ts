...
import { MovieGenre, MovieGenres } from '../../interfaces/movie'
...
export const { genresFetching, genresFetchingSuccess, genresFetchingError, resetState } = genresSlice.actions
